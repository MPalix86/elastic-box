...
import { DrawableSetupOptions, ResizableSetupOptions } from './types/area-types';
...
export { Space, Area , ResizableCustomStyle, DrawableSetupOptions, DrawableCustomStyle, DrawableArea, DrawableAreaEvents, AreaEvents, ResizableSetupOptions};
